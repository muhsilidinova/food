      ...
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="flex flex-wrap justify-between gap-8 pb-12 ml-[50px]">
          <div className="w-full sm:w-1/4 ">
            ...
            <p className="text-sm ml-[-70px]">Delicious food delivered right to <br /> your door. Taste the best flavors with us!</p>
          </div>
          <div className="w-full sm:w-1/4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-[#9CAA00] ml-[-150px]">info@foodzero.com</a></li>
          ...
          <div className="ml-[1000px] mt-[-190px]">
