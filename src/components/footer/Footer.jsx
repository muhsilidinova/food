...
export default function Footer() {
  return (
    <div className="bg-[#233000] text-white py-12 mt-[100px] max-w-[1500px] mx-auto ">
      <div className="px-6 ml-[50px]">
        <div className="flex flex-wrap justify-between gap-8 mb-12">
          <div className="w-full sm:w-1/4">
            <img src={surot1} alt="Logo" className="w-[150px] mb-4" />
            <p className="text-sm">
              Delicious food delivered right to your door. Taste the best flavors with us!
            </p>
          </div>
          <div className="w-full sm:w-1/4">
          ...
          <div className="w-full sm:w-1/4">
            ...
            <button className="w-full bg-[#9CAA00] text-white py-2 rounded-md hover:bg-[#7f9000]">Subscribe</button>
          </div>
        </div>
