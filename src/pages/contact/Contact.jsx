...
function Contact() {
  return (
    ...
    <div className='pb-[10px]'style={{ fontFamily: "Rufina, serif" }}>
      <h1 className='text-[23px] ml-[850px] mt-[-120px]'>We can be contacted via</h1>
      <a href="" className='ml-[850px] text-[23px]'>email <span className='text-[#a8b701]'>info@foodzero.com</span></a>
      <h1 className='ml-[850px] text-[23px]'>or telephone on <span className='text-[#a8b701]'>+86 852 346 000</span></h1>
    </div>
    <div className=''>
      <h1 className='mt-[360px] text-[25px]'style={{ fontFamily: "Rufina, serif" }}>We are located in 1959 Sepulveda Blvd. Culver <br/>City, CA, 90230</h1>
      <img src={foto2} className='w-[450px] ml-[750px] mt-[-300px]'/>
      <button className="text-[18px] border border-black px-6 py-2 relative bottom-[220px] rounded-lg hover:bg-[#394e01] hover:text-white transition duration-300 cursor-pointer"style={{ fontFamily: "Rufina, serif" }}>View in Maps</button>
    </div>
    </div>
  )
}
